...
import './footer.css';
import fotterbg from '../../assets/1-1-1920x454.png'
...
import 'react-tippy/dist/tippy.css';
 ...
 <div>  
         <div class="footer-area wow fadeInUp" data-wow-delay="0.7s">
            <div class="footer-top pt-100 pb-70" style={{backgroundImage:'url('+fotterbg+')'}} >
                <div class="container">
                     <div class="row">
                        <div class="col-xl-3 col-lg-3">
                            <div class="widget-item text-hawkes-blue">
                               <div class="footer-logo pb-5">
                                    <a href="#">
                                        <img src="logo.jpg" width="50" height="auto" alt="Logo"/>
                                    </a>
                                </div> 
